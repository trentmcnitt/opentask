...
function getShortcuts(cmdLabel: string) {
  return [
    ...
    { keys: [cmdLabel, 'Shift', 'Arrow Up'], action: 'Jump to first in group' },
    { keys: [cmdLabel, 'Shift', 'Arrow Down'], action: 'Jump to last in group' },
    { keys: [cmdLabel, 'Ctrl', 'Arrow Up'], action: 'Jump to previous group' },
    { keys: [cmdLabel, 'Ctrl', 'Arrow Down'], action: 'Jump to next group' },
