...
export const enrichmentContextScenarios: AITestScenario[] = [
  {
    ...
    input: {
      ...
      userContext:
        'My wife is Casey. My kids are Annie (born Dec 2018) and Troy (born May 2021). I usually work M-F 8am-4pm.',
    },
    requirements: {
      must_include: {
        labels: [],
      ...
      quality_notes:
        'Title MUST include "Casey" instead of "my wife" — e.g., "Flowers for Casey". ' +
  ...
  },
  {
    ...
    input: {
      ...
      userContext: 'My wife is Casey. She usually handles groceries. I usually work M-F 8am-4pm.',
    },
    requirements: {
      must_include: {
        labels: [],
      ...
      quality_notes:
        'Title MUST NOT mention Casey or "wife" — the user said "buy groceries" with no reference to anyone. ' +
  ...
  },
  {
    ...
    requirements: {
      ...
      quality_notes:
        ...
        'Do NOT hallucinate a name or substitute any name from context (Casey, Annie, Troy are not the brother). ' +
