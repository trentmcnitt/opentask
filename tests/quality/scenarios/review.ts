 ...
 * AI Review scenarios
 *
 * Tests the Review feature which scores every task 0-100 based on how much
...
export const reviewScenarios: AITestScenario[] = [
  {
    id: 'review-mixed-priorities',
    feature: 'review',
    description:
  ...
  {
    id: 'review-user-context-job-hunting',
    feature: 'review',
    description:
