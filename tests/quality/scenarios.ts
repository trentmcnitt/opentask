...
export const enrichmentScenarios: AITestScenario[] = [
  ...
  },
  {
    ...
    requirements: {
      ...
      quality_notes:
        'Title should be unchanged: "Fix the door hinge". ' +
...
export const bubbleScenarios: AITestScenario[] = [
  {
    id: 'bubble-snoozed-items',
    feature: 'bubble',
    description: 'Tasks snoozed many times should be surfaced',
    input: {
      timezone: 'America/Chicago',
      tasks: [
        {
    ...
    requirements: {
      must_include: {},
      quality_notes:
        'MUST surface the heavily snoozed tasks (IDs 10, 11, 12). ' +
        'Must NOT surface: daily recurring affirmation (20), shopping (21), or urgent task (22). ' +
        'Reasons should mention snooze count and suggest deciding (do it, delegate, or drop it). ' +
        'Summary should reflect the avoidance pattern.',
    },
  },
  {
    ...
    requirements: {
      must_include: {},
      quality_notes:
        'MUST surface social obligations: Call Grandpa (42), thank-you card (43), RSVP (44). ' +
        ...
        'Reasons should be direct — mention the social/relational aspect.',
    },
  },
  {
