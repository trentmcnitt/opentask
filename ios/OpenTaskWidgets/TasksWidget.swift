...
private enum TasksPreviewData {
    ...
    static var tasks: [TaskDTO] {
        [
            TaskDTO(
                id: 911, projectId: 1, title: "Dark chocolate", priority: 2,
                dueAt: at(daysFromNow: 0, hour: 20, minute: 30)
            ),
            TaskDTO(
                id: 912, projectId: 2, title: "Check if anyone is waiting on me", priority: 3,
                dueAt: at(daysFromNow: 1, hour: 9)
            ),
            TaskDTO(
                id: 913, projectId: 2, title: "Log client hours before the weekly cutoff", priority: 2,
                dueAt: nextSunday(hour: 9)
            ),
            TaskDTO(
                id: 914, projectId: 1, title: "Make sure the old account is cancelled", priority: 2,
