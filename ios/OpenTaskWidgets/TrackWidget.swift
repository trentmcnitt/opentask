...
private enum QuotasPreviewData {
    static var quotas: [TaskDTO] {
        [
            ...
            TaskDTO(id: 276, projectId: 4434, title: "Clean car seat for Owen", priority: 0, rrule: "FREQ=MONTHLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["kids", "house"]),
            TaskDTO(id: 295, projectId: 4434, title: "Reset Router+Modem (just power off everything for 10sec)", priority: 0, rrule: "FREQ=MONTHLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["house"]),
            TaskDTO(id: 309, projectId: 4434, title: "Clean AirPods + Phone Speakers", priority: 0, rrule: "FREQ=MONTHLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["house"]),
            TaskDTO(id: 27, projectId: 4434, title: "All Kids Kazoo", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 1, progressCurrent: 1, trackedFlag: true, labels: ["kids"]),
            TaskDTO(id: 103, projectId: 4434, title: "Kel + I compliment each other in front of kids", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 2, progressCurrent: 0, trackedFlag: true, labels: ["kids", "relationships"]),
            TaskDTO(id: 114, projectId: 4434, title: "All Kids Shower", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 2, progressCurrent: 1, trackedFlag: true, labels: ["kids"]),
            TaskDTO(id: 116, projectId: 1, title: "Kids Eat Broccoli", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 3, progressCurrent: 1, trackedFlag: false, labels: []),
            TaskDTO(id: 129, projectId: 1, title: "All Kids Grinding Food (e.g. Bran, Grape Nuts)", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 3, progressCurrent: 0, trackedFlag: false, labels: []),
            TaskDTO(id: 132, projectId: 4434, title: "Kids Supplements (Vit. D, maybe Omega-3, etc.)", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 3, progressCurrent: 0, trackedFlag: true, labels: ["health", "kids"]),
            TaskDTO(id: 160, projectId: 1, title: "Peanut butter bites", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 2, progressCurrent: 0, trackedFlag: false, labels: []),
            TaskDTO(id: 163, projectId: 4434, title: "Kids all blow up balloon (teach josie PRI position + breathing into upper back, seated?)", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 4, progressCurrent: 0, trackedFlag: true, labels: ["health", "kids"]),
            TaskDTO(id: 192, projectId: 4434, title: "Josie clean dishes (chore)", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 5, progressCurrent: 0, trackedFlag: true, labels: ["kids", "house"]),
            TaskDTO(id: 193, projectId: 1, title: "Kids Eggs", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 2, progressCurrent: 0, trackedFlag: false, labels: []),
            ...
            TaskDTO(id: 605, projectId: 4434, title: "Play poker or another card game with Josie", priority: 2, rrule: "FREQ=WEEKLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["kids", "media"]),
            TaskDTO(id: 3307, projectId: 6, title: "Check for new certifications — Anthropic Skilljar, platform certs, business automation credentials, cowork, automation", priority: 2, rrule: "FREQ=WEEKLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["job-hunt"]),
            TaskDTO(id: 21771, projectId: 1, title: "Play Catch With All Three Kids", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: []),
            TaskDTO(id: 21829, projectId: 1, title: "Kid's Iron Meal (e.g. ground beef, steak)", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 2, progressCurrent: 2, trackedFlag: true, labels: []),
            TaskDTO(id: 23532, projectId: 1, title: "Review audiobook highlights", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["hub"]),
            TaskDTO(id: 23534, projectId: 1, title: "Run the card maintenance skill (/maintenance:cards) in a fresh chat", priority: 0, rrule: "FREQ=WEEKLY", progressTarget: 1, progressCurrent: 0, trackedFlag: true, labels: ["hub", "ai-added"]),
        ].filter(\.isTracked)
    }
...
/// takeback on All Kids Kazoo — the mode STILL ON (2026-09-24; it used to
