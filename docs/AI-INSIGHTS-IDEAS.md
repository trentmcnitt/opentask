...
- **Task-by-task commentary** — possibly a chat-like interface where AI walks through tasks one at a time
- **Batch recommendations** — "These 5 tasks could be grouped into a project", "This task hasn't been touched in 3 weeks"
